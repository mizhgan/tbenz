...
<template>
  <div class="heatmap scroll-shadow-x">
...
/* 24 hourly columns (36px label + 24*22px cells, see .grid below) overflow
   ...
   swipe away. The scroll-shadow fade itself is main.css's shared
   .scroll-shadow-x (applied in the template) - see its own doc comment for
   how/why; just overflow-x:auto is left here since that's specific to this
